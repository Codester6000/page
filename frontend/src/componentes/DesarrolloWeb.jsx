    ...
    return (
        <div className="containerDesarrolloWeb">
            ...
            <div className="proyectosWeb">
                    <a href="https://obemasa.com.ar">
                <div className="cardProyecto" onMouseEnter={()=>setProyectos({...proyectos,1:true})} onMouseLeave={()=>setProyectos({...proyectos,1:false})} id='obema'>
                        <h4 >OBEMA S.A</h4>
                ...
                <a href="">
                <div className="cardProyecto"  onMouseEnter={()=>setProyectos({...proyectos,2:true})} onMouseLeave={()=>setProyectos({...proyectos,2:false})} id='estancia38'>
                    ...
                    <a href="">
                <div className="cardProyecto"  onMouseEnter={()=>setProyectos({...proyectos,3:true})} onMouseLeave={()=>setProyectos({...proyectos,3:false})} id='modex'>
            ...
            <div className="software">
                    <a href="" onMouseEnter={()=>setProyectos({...proyectos,4:true})} onMouseLeave={()=>setProyectos({...proyectos,4:false})}>
                <div className="cardProyecto" id='pdv'  >
                    ...
                    <a href="">
                <div className="cardProyecto"  onMouseEnter={()=>setProyectos({...proyectos,5:true})} onMouseLeave={()=>setProyectos({...proyectos,5:false})} id='vales'>

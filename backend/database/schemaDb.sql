...
INSERT INTO productos (nombre,stock,garantia_meses,ancho,peso,codigo_fabricante,marca)
...
call schemamodex.cargar_precios(precio_dolar, precio_dolar_iva, iva, cotizacion_dolar, precio_pesos, precio_pesos_iva,@id_proveedor,@id_producto);
Else
set @id_proveedor = (SELECT id_proveedor from proveedores WHERE nombre_proveedor = proveedor);
set @id_producto = (SELECT id_producto from productos p WHERE p.codigo_fabricante = codigo_fabricante);
 call schemamodex.actualizar_precios(precio_dolar, precio_dolar_iva, iva, cotizacion_dolar, precio_pesos, precio_pesos_iva,@id_proveedor,@id_producto);   

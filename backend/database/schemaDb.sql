...
-- -----------------------------------------------------
-- Table `schemamodex`.`ventas`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `schemamodex`.`ventas` (
  `id_venta` INT NOT NULL,
  `id_usuario` INT NOT NULL,
  `monto` VARCHAR(45) NOT NULL,
  `estado` VARCHAR(45) NULL DEFAULT 'pendiente',
  `fecha_venta` TIMESTAMP NULL DEFAULT CURRENT_TIMESTAMP,
  `nro_operacion` VARCHAR(100) NULL DEFAULT NULL,
...
-- -----------------------------------------------------
-- Table `schemamodex`.`ventas_detalles`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `schemamodex`.`ventas_detalles` (
  ...
  `fecha_vd` TIMESTAMP NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id_venta_detalle`),
  INDEX `fk_ventas_detalles_ventas1_idx` (`id_venta` ASC) VISIBLE,
  INDEX `fk_ventas_detalles_productos1_idx` (`id_producto` ASC) VISIBLE,
  CONSTRAINT `fk_ventas_detalles_productos1`
    FOREIGN KEY (`id_producto`)
    REFERENCES `schemamodex`.`productos` (`id_producto`),
  CONSTRAINT `fk_ventas_detalles_ventas1`
    FOREIGN KEY (`id_venta`)
    REFERENCES `schemamodex`.`ventas` (`id_venta`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
COLLATE = utf8mb4_unicode_ci;
